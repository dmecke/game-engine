...
export default class Gamepads {
    ...
    rumble(left: Rumble, right: Rumble): void {
        this.gamepads.forEach(gamepad => gamepad.rumble(left, right));
    }
    ...
    private onGamepadConnected(event: GamepadEvent): void {
        ...
        this.anyPressedCallbacks.forEach(callback => gamepad.onPressedAny(callback));
        this.anyDownCallbacks.forEach(callback => gamepad.onDownAny(callback));
        this.anyReleasedCallbacks.forEach(callback => gamepad.onReleasedAny(callback));
    }
