...
export default class NineSlice {
    ...
    private drawCorners(ctx: CanvasRenderingContext2D): void {
        ...
        ctx.drawImage(this.image, this.image.width - this.right, 0, this.right, this.top, this.area.right - this.right, this.position.y, this.right, this.top); // top right
        ctx.drawImage(this.image, 0, this.image.height - this.bottom, this.left, this.bottom, this.position.x, this.area.bottom - this.bottom, this.left, this.bottom); // bottom left
        ctx.drawImage(this.image, this.image.width - this.right, this.image.height - this.bottom, this.right, this.bottom, this.area.right - this.right, this.area.bottom - this.bottom, this.right, this.bottom); // bottom right
    }
    ...
    private drawEdges(ctx: CanvasRenderingContext2D): void {
        ...
        ctx.drawImage(this.image, this.left, this.image.height - this.bottom, this.image.width - this.left - this.right, this.bottom, this.position.x + this.left, this.area.bottom - this.bottom, this.size.x - this.left - this.right, this.bottom); // bottom
        ...
        ctx.drawImage(this.image, this.image.width - this.right, this.top, this.right, this.image.height - this.top - this.bottom, this.area.right - this.right, this.position.y + this.top, this.right, this.size.y - this.top - this.bottom); // right
    }
